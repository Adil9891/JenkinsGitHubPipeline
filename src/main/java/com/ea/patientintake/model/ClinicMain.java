...
public class ClinicMain {
  // ceci est un commentaire 6

  private static ClinicCalendar calendar;

  public static void startConsole() throws Throwable {
  ...
  private static Optional<PatientAppointment> findPatientAppointment(
    ...
    return calendar
        ...
        .filter(
            p ->
                (p.getPatientLastName().equalsIgnoreCase(lastName)
